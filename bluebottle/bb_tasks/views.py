...
from bluebottle.projects.permissions import RelatedProjectOwnerOrReadOnlyPermission
...
class BaseTaskList(ListCreateAPIView):
    queryset = Task.objects.all()
    pagination_class = TaskPreviewPagination
    permission_classes = (TenantConditionalOpenClose, RelatedProjectOwnerOrReadOnlyPermission,)
