...
from bluebottle.utils.views import (ListCreateAPIView, RetrieveUpdateDestroyAPIView,
                                    ListAPIView)
from .permissions import IsOwner, CanEmailFollowers
...
class TextWallpostList(SetAuthorMixin, ListCreateAPIView):
    ...
    permission_classes = (TenantConditionalOpenClose, CanEmailFollowers,)
...
class TextWallpostDetail(SetAuthorMixin, RetrieveUpdateDestroyAPIView):
    queryset = TextWallpost.objects.all()
    serializer_class = TextWallpostSerializer
...
class WallpostDetail(RetrieveUpdateDestroyAPIView):
    queryset = Wallpost.objects.all()
    serializer_class = WallpostSerializer
    permission_classes = (TenantConditionalOpenClose, IsOwner,)
